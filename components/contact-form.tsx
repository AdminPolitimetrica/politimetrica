...
import { saveContactMessageWithSuggestions, supabase } from "@/lib/supabaseClient"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!user) {
      toast({
        ...
        description: "Debes registrarte para enviar sugerencias.",
        variant: "destructive",
      })
      return
    }
  ...
  if (!user) {
    return (
      <Card className="max-w-md mx-auto p-6 text-center">
        <h2 className="text-xl font-semibold mb-4">Debes registrarte para enviar sugerencias</h2>
        <Button onClick={goToRegister} size="lg">
          Registrarse
        </Button>
      </Card>
    )
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="politician-image"
                  name="image"
                  placeholder="URL de la imagen del político"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  id="politician-party"
                  name="party_id"
                  placeholder="ID o nombre corto del partido"
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Cargo actual del político"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="party-id"
                  name="id"
                  placeholder="ID o siglas del partido"
